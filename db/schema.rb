...
ActiveRecord::Schema[7.0].define(version: 2023_05_09_061652) do
  create_table "accounts", force: :cascade do |t|
    ...
    t.boolean "normaluser", default: true
  ...
  create_table "favorite_properties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_favorite_properties_on_account_id"
  ...
  add_foreign_key "favorite_properties", "accounts"
